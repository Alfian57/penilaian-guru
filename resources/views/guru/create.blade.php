...
@section('title', 'Tambah Guru - Sistem Penilaian Guru')
...
@section('content')
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-800 mt-2">Tambah Data Guru</h1>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="md:col-span-2">
                    ...
                    @if($penggunaList->isEmpty())
                        <p class="mt-1 text-sm text-yellow-600">Tidak ada pengguna yang tersedia. Silakan tambah pengguna dengan
                            peran Guru atau Kepala Sekolah terlebih dahulu.</p>
                    @endif
                </div>
