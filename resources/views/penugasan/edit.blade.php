...
@section('title', 'Edit Penugasan - Sistem Penilaian Guru')
...
@section('content')
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-800 mt-2">Edit Penugasan</h1>
    </div>
                ...
                <div>
                    ...
                    <select name="periode_id" id="periode_id" required
                        ...
                        @foreach($periodeList as $p)
                            <option value="{{ $p->id }}" {{ old('periode_id', $penugasan->periode_id) == $p->id ? 'selected' : '' }}>
                                {{ $p->nama_periode }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <select name="penilai_id" id="penilai_id" required
                        ...
                        @foreach($penilaiList as $p)
                            <option value="{{ $p->id }}" {{ old('penilai_id', $penugasan->penilai_id) == $p->id ? 'selected' : '' }}>
                ...
                <div class="md:col-span-2">
                    ...
                    <select name="guru_id" id="guru_id" required
                        ...
                        @foreach($guruList as $g)
                            <option value="{{ $g->id }}" {{ old('guru_id', $penugasan->guru_id) == $g->id ? 'selected' : '' }}>
