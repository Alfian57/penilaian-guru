...
@section('title', 'Edit Periode - Sistem Penilaian Guru')
...
@section('content')
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-800 mt-2">Edit Periode Akademik</h1>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    <label class="flex items-center">
                        <input type="checkbox" name="status_aktif" value="1" {{ old('status_aktif', $periode->status_aktif) ? 'checked' : '' }}
